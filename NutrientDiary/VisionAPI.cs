...
//    using QuickType;
//
//    var objects = Objects.FromJson(jsonString);
...
namespace QuickType
{
    ...
    public partial class Objects
    {
        public static Objects FromJson(string json) => JsonConvert.DeserializeObject<Objects>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Objects self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
